...
Write-Host "=== Health Logger Version Reset Script ===" -ForegroundColor Cyan
Write-Host ""
...
$swPath = "HealthLogger\wwwroot\service-worker.js"
$swContent = Get-Content $swPath -Raw

# Extract current version
if ($swContent -match "const CACHE_VERSION = '([^']+)';") {
    ...
    $swContent = $swContent -replace "const CACHE_VERSION = '[^']+';", "const CACHE_VERSION = '$fixedTimestamp';"
...
$htmlFiles = Get-ChildItem "HealthLogger\wwwroot" -Filter "*.html" -Recurse
...
$jsFiles = Get-ChildItem "HealthLogger\wwwroot\js" -Filter "*.js" -Recurse
...
$cssFiles = Get-ChildItem "HealthLogger\wwwroot\css" -Filter "*.css" -Recurse -ErrorAction SilentlyContinue
